...
def get_recruit_embed(user_id: int, bot: RecruitBot, session: Session = None) -> Optional[Tuple[discord.Embed, RecruitView]]:
    ...
    button_send = discord.ui.Button(label="Send TG", style=discord.ButtonStyle.link,
